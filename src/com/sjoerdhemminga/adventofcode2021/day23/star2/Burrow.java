...
import static com.sjoerdhemminga.adventofcode2021.day23.star2.Layout.RTR;
import static com.sjoerdhemminga.adventofcode2021.day23.star2.Layout.RTSH;
import static com.sjoerdhemminga.adventofcode2021.day23.star2.Layout.RoomToRoom;
import static com.sjoerdhemminga.adventofcode2021.day23.star2.Layout.RoomToSmallHall;
import static com.sjoerdhemminga.adventofcode2021.day23.star2.Layout.SHTR;
import static com.sjoerdhemminga.adventofcode2021.day23.star2.Layout.SmallHallToRoom;
...
record Burrow(Map<RoomName, Room> rooms, Map<SmallHallName, SmallHall> smallHalls, int expendedEnergy) {
    static Burrow ofString(final String topSpots, final String bottomSpots) {
        final Map<RoomName, Room> rooms = Stream.of(
                        new Room(A_HALL, '.', '.', 'X', 'X'),
                        new Room(A_ROOM, topSpots.charAt(0), 'D', 'D', bottomSpots.charAt(0)),
                        new Room(B_ROOM, topSpots.charAt(1), 'C', 'B', bottomSpots.charAt(1)),
                        new Room(C_ROOM, topSpots.charAt(2), 'B', 'A', bottomSpots.charAt(2)),
                        new Room(D_ROOM, topSpots.charAt(3), 'A', 'C', bottomSpots.charAt(3)),
                        new Room(D_HALL, '.', '.', 'X', 'X'))
    ...
    private Stream<Burrow> move(final Room from, final Room to) {
        ...
        final int baseSteps = from.leaveSteps() + intermediates.size() * 2;

        final Room shallowEnteredRoom = to.enterShallow(from.leaver());
        final int shallowCost = moveCost(from.leaver(), baseSteps + to.shallowEnterSteps());
        ...
        final int deepCost = moveCost(from.leaver(), baseSteps + to.deepEnterSteps());
    ...
    private Stream<Burrow> move(final SmallHall from, final Room to) {
        ...
        final int baseSteps = 1 + intermediates.size() * 2 ;
    ...
    public String toString() {
        return new StringBuilder()
                ...
                .append("###\n")
                .append("|   #")
                .append(rooms.get(A_ROOM).deep1())
                .append('|')
                .append(rooms.get(B_ROOM).deep1())
                .append('|')
                .append(rooms.get(C_ROOM).deep1())
                .append('|')
                .append(rooms.get(D_ROOM).deep1())
                .append("#\n")
                .append("|   #")
                .append(rooms.get(A_ROOM).deep2())
                .append('|')
                .append(rooms.get(B_ROOM).deep2())
                .append('|')
                .append(rooms.get(C_ROOM).deep2())
                .append('|')
                .append(rooms.get(D_ROOM).deep2())
                .append("#\n")
                .append("|   #")
                .append(rooms.get(A_ROOM).deep3())
                .append('|')
                .append(rooms.get(B_ROOM).deep3())
                .append('|')
                .append(rooms.get(C_ROOM).deep3())
                .append('|')
                .append(rooms.get(D_ROOM).deep3())
                .append("#\n")
                .append("|   #########\n")
                .toString();
    }
